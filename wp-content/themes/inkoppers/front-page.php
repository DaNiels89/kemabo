...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-3">
            <div class="red-bgc-div-team">
                <h2 class="team-title">Ons<br /> team</h2>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="row">
        <div class="col">
             <div class="team-member-div">
                <img src="/kemabo/wp-content/uploads/2021/08/team-member-overlay-image.png" alt="" class="">
                <div class="team-member-image-overlay">
                    <div class="team-member-details">
                        <span class="team-member-function">Functie</span>
                        <span class="team-member-name">Teamlid naam</span>
                    </div>
                </div>
             </div>
             <div class="team-member-div">
...
<!-- <div class="container-fluid">
    <div class="row">
        <div class="col">
            <div class="who-are-we-div">
                <div class="who-are-we-img-div">
                    <img src="/kemabo/wp-content/uploads/2021/08/mobile-home-3.png" alt="" class="">
                </div>
                <div class="who-are-we-text-div">
                    <h4 class="red-subtitle">
                        Wie zijn wij?
...
<div class="container-fluid">
    <div class="row">   
        <div class="col-md-5 offset-md-1">
            <div class="recent-projects-div-for-image">
                <img src="/kemabo/wp-content/uploads/2021/08/waterval-groot.png" alt="" class="recent-projects-image img-fluid">
                <div class="recent-projects-image-overlay"></div>
                <span class="recent-projects-image-top-text latest-news">30 juli 2021</span>
                <span class="recent-projects-image-bottom-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit</span>
                <a href="#" class="recent-projects-image-bottom-a">
                    <svg class="red-rect-svg-smaller" xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30">
                        <rect id="Rectangle_93" data-name="Rectangle 93" width="30" height="30" fill="#e50c00"/>
